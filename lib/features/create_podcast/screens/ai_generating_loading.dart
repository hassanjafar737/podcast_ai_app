...
// import 'package:podcast_ai_app/features/library/screens/library_services.dart';
...
//       final String podcastTitle = "AI Episode: ${DateTime.now().hour}:${DateTime.now().minute}";
//       await LibraryServices.savePodcast(
//         title: podcastTitle,
//         audioPaths: audioPaths,
//         voiceName: "Gemini + ElevenLabs",
//       );
...
//           audioPaths: audioPaths,
//           title: podcastTitle,
//           description: "Generated by VOX AI • ${DateTime.now().day} Oct",
//         ),
//       );
//     } else {
//       if (mounted) {
...
class _AiGeneratingLoadingState extends State<AiGeneratingLoading> with SingleTickerProviderStateMixin {
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          color: Colors.white,
                          fontWeight: FontWeight.bold,
                          fontSize: 19.sp.clamp(16.0, 24.0),
                        ),
                      ),
                        ...
                        builder: (context, child) {
                          return Container(
                            ...
                            child: FractionallySizedBox(
                              ...
                              widthFactor: 0.3 + (_progressController.value * 0.6), // Simulates beautiful movement
                              child: Container(
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(20.r),
                                  gradient: const LinearGradient(
